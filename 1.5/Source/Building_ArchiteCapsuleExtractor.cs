...
namespace ArchiteCapsuleExtractor
{
	...
	public class Building_ArchiteCapsuleExtractor : Building_Enterable, IThingHolderWithDrawnPawn, IThingHolder
	{
		...
		public override IEnumerable<FloatMenuOption> GetFloatMenuOptions(Pawn selPawn)
		{
			...
			{
				yield return new FloatMenuOption("CannotEnterBuilding".Translate(this) + ": " + "NoPath".Translate().CapitalizeFirst(), null, MenuOptionPriority.Default, null, null, 0f, null, null, true, 0);
			}
			else
			{
		...
		public override IEnumerable<Gizmo> GetGizmos()
		{
			...
			command_Action4.action = delegate
			{
                ...
                listPawns.SortBy((Pawn pawn) => countMaxCapsules(pawn));
		...
		public override void DynamicDrawPhaseAt(DrawPhase phase, Vector3 drawLoc, bool flip = false)
		{
			...
			if (base.Working && this.ContainedPawn != null)
			{
				drawLoc.x = drawLoc.x + BuildingRotationOffsetX(this.Rotation);
				drawLoc.z = drawLoc.z + BuildingRotationOffsetY(this.Rotation);
				this.ContainedPawn.Drawer.renderer.DynamicDrawPhaseAt(phase, drawLoc + this.PawnDrawOffset, null, true);
			}
		}
